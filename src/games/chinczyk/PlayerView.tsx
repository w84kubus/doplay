    ...
    <div className="flex w-full max-w-md flex-col items-center gap-4">
      ...
      {!koniecPartii && (
        <div className="flex flex-col items-center gap-3">
          <Kostka wartosc={pub.kostka} kolor={barwaTury} />
          ...
          {pub.phase === "ruch" && mojaTura && (
            <p className="text-center text-sm font-semibold text-ink">{t("chinczyk.pickPiece")}</p>
          )}

          {/* Dwie szóstki pod rząd to informacja, że trzecia przepadnie. */}
          {mojaTura && pub.szostki > 0 && (
            <p className="text-xs font-semibold text-bursztyn">
